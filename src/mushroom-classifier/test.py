...
from TrainingDiagnostics import plot_cost, plot_learning_curve
...
learning_curve = plot_learning_curve(train_X, train_y, test_X, test_y, model_for_learning_curve)
learning_curve.savefig("learningcurve.jpg")
